...
const MET_CULTURE: Record<string, string> = {
  ...
  BE: 'Flemish', AU: 'Australian', CN: 'Chinese', IN: 'Indian',
  BR: 'Brazilian', MX: 'Mexican', CA: 'Canadian', AT: 'Austrian',
  RU: 'Russian', GR: 'Greek', EG: 'Egyptian', TR: 'Turkish',
  VN: 'Vietnamese', KR: 'Korean', TH: 'Thai', PL: 'Polish',
  SE: 'Swedish', NO: 'Norwegian', DK: 'Danish', PT: 'Portuguese',
}
